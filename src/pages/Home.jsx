...
const Home = () => {
  return (
    <section className='home bg-p_silverDark flex  h-full items-end md:p-16' id='home'>
      <div className='mx-auto max-w-6xl flex gap-4 flex-col-reverse items-center  md:flex-row pt-44 md:pt-28 '>
